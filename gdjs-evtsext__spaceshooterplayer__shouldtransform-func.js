...
gdjs.evtsExt__SpaceShooterPlayer__ShouldTransform.conditionTrue_0 = {val:false};
gdjs.evtsExt__SpaceShooterPlayer__ShouldTransform.condition0IsTrue_0 = {val:false};
gdjs.evtsExt__SpaceShooterPlayer__ShouldTransform.condition1IsTrue_0 = {val:false};
gdjs.evtsExt__SpaceShooterPlayer__ShouldTransform.condition2IsTrue_0 = {val:false};
...
gdjs.evtsExt__SpaceShooterPlayer__ShouldTransform.condition1IsTrue_0.val = false;
{
gdjs.evtsExt__SpaceShooterPlayer__ShouldTransform.condition0IsTrue_0.val = gdjs.evtTools.input.cursorOnObject(gdjs.evtsExt__SpaceShooterPlayer__ShouldTransform.mapOfGDgdjs_46evtsExt_95_95SpaceShooterPlayer_95_95ShouldTransform_46GDChangeButtonObjects1Objects, runtimeScene, false, false);
}if ( gdjs.evtsExt__SpaceShooterPlayer__ShouldTransform.condition0IsTrue_0.val ) {
{
gdjs.evtsExt__SpaceShooterPlayer__ShouldTransform.condition1IsTrue_0.val = gdjs.evtTools.input.isMouseButtonPressed(runtimeScene, "Left");
}}
if (gdjs.evtsExt__SpaceShooterPlayer__ShouldTransform.condition1IsTrue_0.val) {
...
gdjs.evtsExt__SpaceShooterPlayer__ShouldTransform.condition0IsTrue_0.val = false;
{
gdjs.evtsExt__SpaceShooterPlayer__ShouldTransform.condition0IsTrue_0.val = gdjs.evtTools.input.isKeyPressed(runtimeScene, "Return");
}if (gdjs.evtsExt__SpaceShooterPlayer__ShouldTransform.condition0IsTrue_0.val) {
{if (typeof eventsFunctionContext !== 'undefined') { eventsFunctionContext.returnValue = true; }}}

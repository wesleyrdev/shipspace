...
gdjs.evtsExt__CameraShake__SetLayerShakingFrequency.conditionTrue_0 = {val:false};
gdjs.evtsExt__CameraShake__SetLayerShakingFrequency.condition0IsTrue_0 = {val:false};
gdjs.evtsExt__CameraShake__SetLayerShakingFrequency.condition1IsTrue_0 = {val:false};
gdjs.evtsExt__CameraShake__SetLayerShakingFrequency.conditionTrue_1 = {val:false};
gdjs.evtsExt__CameraShake__SetLayerShakingFrequency.condition0IsTrue_1 = {val:false};
gdjs.evtsExt__CameraShake__SetLayerShakingFrequency.condition1IsTrue_1 = {val:false};
...
gdjs.evtsExt__CameraShake__SetLayerShakingFrequency.condition0IsTrue_0.val = false;
{
{gdjs.evtsExt__CameraShake__SetLayerShakingFrequency.conditionTrue_1 = gdjs.evtsExt__CameraShake__SetLayerShakingFrequency.condition0IsTrue_0;
gdjs.evtsExt__CameraShake__SetLayerShakingFrequency.conditionTrue_1.val = ((typeof eventsFunctionContext !== 'undefined' ? "" + eventsFunctionContext.getArgument("Layer") : "") == "");
}
}if (gdjs.evtsExt__CameraShake__SetLayerShakingFrequency.condition0IsTrue_0.val) {

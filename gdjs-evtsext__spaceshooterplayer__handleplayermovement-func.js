...
gdjs.evtsExt__SpaceShooterPlayer__HandlePlayerMovement.conditionTrue_0 = {val:false};
gdjs.evtsExt__SpaceShooterPlayer__HandlePlayerMovement.condition0IsTrue_0 = {val:false};
gdjs.evtsExt__SpaceShooterPlayer__HandlePlayerMovement.condition1IsTrue_0 = {val:false};
gdjs.evtsExt__SpaceShooterPlayer__HandlePlayerMovement.condition2IsTrue_0 = {val:false};
...
for(var i = 0, k = 0, l = gdjs.evtsExt__SpaceShooterPlayer__HandlePlayerMovement.GDPlayerObjects2.length;i<l;++i) {
    if ( gdjs.evtsExt__SpaceShooterPlayer__HandlePlayerMovement.GDPlayerObjects2[i].getX() > gdjs.evtTools.input.getCursorX(runtimeScene, "", 0) + 10 ) {
        gdjs.evtsExt__SpaceShooterPlayer__HandlePlayerMovement.condition0IsTrue_0.val = true;
...
gdjs.evtsExt__SpaceShooterPlayer__HandlePlayerMovement.GDPlayerObjects2.length = k;}if (gdjs.evtsExt__SpaceShooterPlayer__HandlePlayerMovement.condition0IsTrue_0.val) {
...
gdjs.evtsExt__SpaceShooterPlayer__HandlePlayerMovement.GDPlayerObjects1.length = k;}if (gdjs.evtsExt__SpaceShooterPlayer__HandlePlayerMovement.condition0IsTrue_0.val) {
...
gdjs.evtsExt__SpaceShooterPlayer__HandlePlayerMovement.condition1IsTrue_0.val = false;
{
gdjs.evtsExt__SpaceShooterPlayer__HandlePlayerMovement.condition0IsTrue_0.val = gdjs.evtTools.input.isMouseButtonPressed(runtimeScene, "Left");
}if ( gdjs.evtsExt__SpaceShooterPlayer__HandlePlayerMovement.condition0IsTrue_0.val ) {
{
gdjs.evtsExt__SpaceShooterPlayer__HandlePlayerMovement.condition1IsTrue_0.val = gdjs.evtTools.input.cursorOnObject(gdjs.evtsExt__SpaceShooterPlayer__HandlePlayerMovement.mapOfGDgdjs_46evtsExt_95_95SpaceShooterPlayer_95_95HandlePlayerMovement_46GDChangeButtonObjects1Objects, runtimeScene, true, true);
}}
if (gdjs.evtsExt__SpaceShooterPlayer__HandlePlayerMovement.condition1IsTrue_0.val) {
...
gdjs.evtsExt__SpaceShooterPlayer__HandlePlayerMovement.condition0IsTrue_0.val = false;
{
gdjs.evtsExt__SpaceShooterPlayer__HandlePlayerMovement.condition0IsTrue_0.val = gdjs.evtTools.input.isKeyPressed(runtimeScene, "Left");
}if (gdjs.evtsExt__SpaceShooterPlayer__HandlePlayerMovement.condition0IsTrue_0.val) {
gdjs.copyArray(eventsFunctionContext.getObjects("Player"), gdjs.evtsExt__SpaceShooterPlayer__HandlePlayerMovement.GDPlayerObjects1);
{for(var i = 0, len = gdjs.evtsExt__SpaceShooterPlayer__HandlePlayerMovement.GDPlayerObjects1.length ;i < len;++i) {
...
gdjs.evtsExt__SpaceShooterPlayer__HandlePlayerMovement.condition0IsTrue_0.val = false;
{
gdjs.evtsExt__SpaceShooterPlayer__HandlePlayerMovement.condition0IsTrue_0.val = gdjs.evtTools.input.isKeyPressed(runtimeScene, "Right");
}if (gdjs.evtsExt__SpaceShooterPlayer__HandlePlayerMovement.condition0IsTrue_0.val) {
gdjs.copyArray(eventsFunctionContext.getObjects("Player"), gdjs.evtsExt__SpaceShooterPlayer__HandlePlayerMovement.GDPlayerObjects1);
{for(var i = 0, len = gdjs.evtsExt__SpaceShooterPlayer__HandlePlayerMovement.GDPlayerObjects1.length ;i < len;++i) {
...
gdjs.evtsExt__SpaceShooterPlayer__HandlePlayerMovement.condition0IsTrue_0.val = false;
{
gdjs.evtsExt__SpaceShooterPlayer__HandlePlayerMovement.condition0IsTrue_0.val = gdjs.evtTools.input.isKeyPressed(runtimeScene, "Down");
}if (gdjs.evtsExt__SpaceShooterPlayer__HandlePlayerMovement.condition0IsTrue_0.val) {
gdjs.copyArray(eventsFunctionContext.getObjects("Player"), gdjs.evtsExt__SpaceShooterPlayer__HandlePlayerMovement.GDPlayerObjects1);
{for(var i = 0, len = gdjs.evtsExt__SpaceShooterPlayer__HandlePlayerMovement.GDPlayerObjects1.length ;i < len;++i) {
...
gdjs.evtsExt__SpaceShooterPlayer__HandlePlayerMovement.condition0IsTrue_0.val = false;
{
gdjs.evtsExt__SpaceShooterPlayer__HandlePlayerMovement.condition0IsTrue_0.val = gdjs.evtTools.input.isKeyPressed(runtimeScene, "Up");
}if (gdjs.evtsExt__SpaceShooterPlayer__HandlePlayerMovement.condition0IsTrue_0.val) {
gdjs.copyArray(eventsFunctionContext.getObjects("Player"), gdjs.evtsExt__SpaceShooterPlayer__HandlePlayerMovement.GDPlayerObjects1);
{for(var i = 0, len = gdjs.evtsExt__SpaceShooterPlayer__HandlePlayerMovement.GDPlayerObjects1.length ;i < len;++i) {
    gdjs.evtsExt__SpaceShooterPlayer__HandlePlayerMovement.GDPlayerObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("TopDownMovement")).simulateUpKey();

...
gdjs.evtsExt__SpaceShooterPlayer__GoingDown.conditionTrue_0 = {val:false};
gdjs.evtsExt__SpaceShooterPlayer__GoingDown.condition0IsTrue_0 = {val:false};
gdjs.evtsExt__SpaceShooterPlayer__GoingDown.condition1IsTrue_0 = {val:false};
gdjs.evtsExt__SpaceShooterPlayer__GoingDown.condition2IsTrue_0 = {val:false};
...
for(var i = 0, k = 0, l = gdjs.evtsExt__SpaceShooterPlayer__GoingDown.GDPlayerObjects1.length;i<l;++i) {
    if ( gdjs.evtsExt__SpaceShooterPlayer__GoingDown.GDPlayerObjects1[i].getVariableNumber(gdjs.evtsExt__SpaceShooterPlayer__GoingDown.GDPlayerObjects1[i].getVariables().get("GoingUp")) == 0 ) {
        gdjs.evtsExt__SpaceShooterPlayer__GoingDown.condition0IsTrue_0.val = true;
...
gdjs.evtsExt__SpaceShooterPlayer__GoingDown.GDPlayerObjects1.length = k;}if ( gdjs.evtsExt__SpaceShooterPlayer__GoingDown.condition0IsTrue_0.val ) {
{
for(var i = 0, k = 0, l = gdjs.evtsExt__SpaceShooterPlayer__GoingDown.GDPlayerObjects1.length;i<l;++i) {
    if ( gdjs.evtsExt__SpaceShooterPlayer__GoingDown.GDPlayerObjects1[i].getVariableNumber(gdjs.evtsExt__SpaceShooterPlayer__GoingDown.GDPlayerObjects1[i].getVariables().get("GoingDown")) == 1 ) {
        gdjs.evtsExt__SpaceShooterPlayer__GoingDown.condition1IsTrue_0.val = true;
        gdjs.evtsExt__SpaceShooterPlayer__GoingDown.GDPlayerObjects1[k] = gdjs.evtsExt__SpaceShooterPlayer__GoingDown.GDPlayerObjects1[i];
        ++k;
    }
}
gdjs.evtsExt__SpaceShooterPlayer__GoingDown.GDPlayerObjects1.length = k;}}
if (gdjs.evtsExt__SpaceShooterPlayer__GoingDown.condition1IsTrue_0.val) {

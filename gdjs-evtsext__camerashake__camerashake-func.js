...
gdjs.evtsExt__CameraShake__CameraShake.conditionTrue_1.val = ((typeof eventsFunctionContext !== 'undefined' ? Number(eventsFunctionContext.getArgument("ShakePeriod")) || 0 : 0) != 0);
}
...
gdjs.evtsExt__CameraShake__CameraShake.condition0IsTrue_0.val = false;
{
gdjs.evtsExt__CameraShake__CameraShake.condition0IsTrue_0.val = gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("__CameraShake").getChild("Duration")) == 0;
}if (gdjs.evtsExt__CameraShake__CameraShake.condition0IsTrue_0.val) {
